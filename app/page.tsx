  ...
  return (
    <main className="min-h-screen bg-[var(--gh-canvas)] text-[var(--gh-fg-body)]">
      <header className="border-b border-[var(--gh-border-muted)]">
        <nav className="mx-auto flex max-w-[1080px] items-center gap-2 px-6 py-4" aria-label="Main navigation">
          ...
          <div className="ml-auto flex items-center gap-5 text-sm">
            <a href="#how" className="hidden text-[var(--gh-fg-body)] no-underline hover:text-[var(--gh-fg)] sm:block">How it works</a>
      ...
      <section className="mx-auto grid max-w-[1080px] grid-cols-[minmax(0,1fr)] gap-12 px-6 py-16 lg:grid-cols-[minmax(0,5fr)_minmax(0,4fr)]">
        <div>
          <p className="mb-4 font-mono text-xs text-[var(--gh-fg-muted)]"><span className="text-[var(--gh-success)]">●</span> v0.1 — Daytona HackSprint build</p>
          ...
          <p className="mt-5 max-w-[46ch] text-base leading-7 text-[var(--gh-fg-muted)]">Paste a public GitHub URL. Try SDK clones it into an isolated Daytona sandbox, starts the repository’s own dev server, and gives you a live preview link before you clone anything.</p>
