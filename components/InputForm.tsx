...
export function InputForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-[35rem]">
      ...
      <p className="mt-3 text-xs leading-5 text-[#6e7681]">Works with public Vite projects — React, Vue, Svelte, Solid, and vanilla JS. Sandboxes are isolated and clean themselves up when abandoned.</p>
