...
export function LiveLaunchPanel() {
  ...
  return (
    <aside id="how" className="min-h-[27rem] min-w-0 overflow-hidden rounded-lg border border-[var(--gh-border)] bg-[var(--gh-surface)] shadow-[0_16px_48px_rgba(1,4,9,0.18)]">
